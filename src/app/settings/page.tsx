...
import { getAutoPostEnabled, getTeamsWebhookUrl, getWorkdayMinutes } from "@/lib/settings";
...
export default async function SettingsPage() {
  ...
  const [webhook, workdayMinutes, autoPost, categories, users] = await Promise.all([
    getTeamsWebhookUrl(),
    getWorkdayMinutes(),
    getAutoPostEnabled(),
