...
received"**. Copy the URL it produces into `/settings` and press **Send a test message**.

Old-style Office 365 connector URLs (`outlook.office.com`) still work — the app detects which
kind it has been given and sends the matching payload shape.
